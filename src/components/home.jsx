...
import { ARIDEV } from '../assets/ARI.DEV.png'

extend({ MeshLineGeometry, MeshLineMaterial })
useGLTF.preload('https://assets.vercel.com/image/upload/contentful/image/e5382hct74si/5huRVDzcoDwnbgrKUo1Lzs/53b6dd7d6b4ffcdbd338fa60265949e1/tag.glb')
useTexture.preload({ARIDEV})

export default function Home() {

    return (
            <div className="flex h-screen justify-evenly">
                <div className="fixed top-40 left-0 w-screen flex flex-row justify-between">
                ...
                <Canvas camera={{ position: [0, 0, 13], fov: 25 }} className=''>
                <ambientLight intensity={Math.PI} />
                <Physics interpolate gravity={[0, -40, 0]} timeStep={1 / 60}>
                    <Band />
                </Physics>
                <Environment background blur={0.75} className = 'w-[600px] block'>
...
function Band({ maxSpeed = 50, minSpeed = 10 }) {
    ...
    const texture = useTexture({ARIDEV})
